...
# Kess Ahmed, 8th July 2025

print("Hello World)
# SyntaxError: unterminated string literal (detected at line 6)
# Missing " closing the string literal

print("Hello Worl")
# Works
# Missing letters are not spelled checked, syntax is correct for python because enclosed in double ""
